...
class VentanaVariantes():
    raiz = 0

    def __init__(self, raizAntigua, variante):
        ...
        self.lIntroduccion = Label(raiz, text='Variants of entered disease', bg="navy", fg="white",
                                   font=("Verdana", 20))
        self.lIntroduccion.place(x=0, y=0, width=1200, height=60)

        self.tVariantes = Text(raiz)
        self.tVariantes.place(x=200, y=120, width=800, height=380)

        self.tVariantes.insert("1.0", variante.toString)
